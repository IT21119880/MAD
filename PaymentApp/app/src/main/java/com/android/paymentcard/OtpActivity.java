...
public class OtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println(getIntent().getStringExtra("phoneNumber"));
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString()) ){
                    ...
                    String phone ="+94"+edtPhone.getText().toString();
                    sendVerificationCode(phone.replace("+940","+94"));
                }
            }
        });
...
//                    verifyCode(edtOTP.getText().toString());
                    Intent i =new Intent(OtpActivity.this,PaymentSuccess.class);
                    startActivity(i);
                    finish();
                }
    ...
    private void sendVerificationCode(String number) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                OtpActivity.this,//this task will be excuted on Main thread.
